        ...
        <div class="box-tools pull-right">
            <ul class="pagination" style="">
                ...
                <c:if test="${pageInfo.pageNum==1}">
                    <li class="disabled">
                        <a  href="${pageContext.request.contextPath}/category/page?page=${pageInfo.pages}&size=5" aria-label="Next">
                ...
                <c:if test="${pageInfo.pageNum!=1}">
                    <li>
                        <a  href="${pageContext.request.contextPath}/category/page?page=${pageInfo.pageNum-1}&size=5">
                            <span aria-hidden="true">上一页</span>
                        </a>
                    </li>
                </c:if>
                ...
                <c:if test="${pageInfo.pageNum == pageInfo.pages}">
                    <li class="disabled" class="nextPage">
                        <a  href="${pageContext.request.contextPath}/category/page?page=1&size=5" aria-label="Previous">
